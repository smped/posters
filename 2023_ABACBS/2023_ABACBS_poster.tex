...
\begin{columns}
    \column{0.32}
        ...
        \small
        	...
        	Genomic variants unique to Indigenous Australians
        \end{minipage}
        \vspace{1cm}
...
%		The unique design of the study also presents a unique opportunity to include population-level diversity across all -omics layers in the study.
    ...
    \block{STAR Consensus Results}{
		...
		~\\
		\textit{\normalsize Differential Gene Expression results showing genes which passed an FDR of 0.05 for consideration as differentially expressed}
